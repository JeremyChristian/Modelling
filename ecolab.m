function ecolab(size,nred,ngrey,nsteps,fmode,outImages)
...
%create_environment.m)
    ...
    [agent]=create_agents(nred,ngrey);       %create nr rabbit and nf fox agents and places them in a cell array called 'agents'
    create_messages(nred,ngrey,agent);       %sets up the initial message lists
    initialise_results(nred,ngrey,nsteps);   %initilaises structure for storing results
    %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
    %MODEL EXECUTION
...
eval(['save results_nred_' num2str(nred) '_ngrey_' num2str(ngrey) '.mat IT_STATS ENV_DATA' ]);
clear global
